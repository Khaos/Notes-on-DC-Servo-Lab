...
\begin{tikzpicture}[every node/.style={font=\small}]
    ...
    \sbDecaleNoeudy[-4]{piref}{pref}
    \sbDecaleNoeudy[4]{piref}{iref}
    \sbBloc[1.5]{p}{$1$}{pref}
    \sbBloc[1.5]{i}{$\dfrac{1}{sT_i}$}{iref}
...
%        \sbRelier{comp}{piref}
    ...
    \sbBloc[2]{gain}{$K_a$}{pisum}
        \sbRelier{pisum}{gain}
    \sbStyleBloc{minimum width=3em, fill=yellow!20, thick}
    \sbBloc[2]{system}{$\dfrac{K}{(1+sT)}$}{gain}
        \sbRelier{gain}{system}
    ...
    \sbSortie[4]{output}{integral}
        \sbRelier{integral}{output}
        \sbNomLien[0.8]{output}{$\theta_o(t)$}
    \sbRenvoi[8]{integral-output}{comp}{}
    \sbDecaleNoeudy[-8]{system}{VfRef}
    \sbStyleBloc{minimum width=3em, fill=red!20, thick}
